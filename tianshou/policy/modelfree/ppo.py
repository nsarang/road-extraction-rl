...
class PPOPolicy(A2CPolicy):
    ...
    def learn(  # type: ignore
        ...
        surr1_losses, surr2_losses, ratio_list = [[]] * 3
        ...
        for step in range(repeat):
            ...
            for b in batch.split(batch_size, merge_last=True):
                ...
                surr1_losses.append(surr1.mean().item())
                surr2_losses.append(surr2.mean().item())
        ...
        return {
            ...
            "loss/surr1": surr1_losses,
            "loss/surr2": surr2_losses,
            "loss/ratio": ratio_list,
            "loss/advantage": batch.adv.mean().item(),
            "loss/v_s": batch.v_s.mean().item(),
            "loss/returns": batch.returns.mean().item(),
        }
